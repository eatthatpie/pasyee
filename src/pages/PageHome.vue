...
import Dynamometer from "./../components/Dynamometer.vue";
import Filters from "./../components/Filters.vue";
import Lengthbar from "./../components/Lengthbar.vue";
  ...
  methods: {
    ...
    onPasswordCopy() {
      this.$refs.alert.open(
        "Password copied. Remember to remove it from the clipboard ASAP."
      );
    },
