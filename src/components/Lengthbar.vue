<template>
  ...
  >
    ...
    <div
      class="lengthbar-pointer"
      ref="pointer"
      :style="{ left: pointerPositionX + 'px' }"
    >
      <div class="lengthbar-label">
        <div class="lengthbar-label-frame">
          <div
            class="lengthbar-label-list"
            :style="{ transform: 'translateY(-' + labelPositionY + 'px)' }"
          >
...
export default {
  ...
  methods: {
    ...
    onMove: throttle(function (e) {
      ...
      this.pointerPositionX =
        (relativeX * (offsetWidth - this.$refs.pointer.offsetWidth)) /
        offsetWidth;

      if (this.func === null) {
        this.length =
          Math.ceil(
            (this.max * relativeX * this.minMaxRatioFactor) / offsetWidth
          ) + this.min;
      ...
      this.length = Math.ceil(
        this.func.call(this.func, relativeX / offsetWidth)
      );
    }, 15),
  },
};
